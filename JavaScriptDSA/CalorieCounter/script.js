...
// Variables
let isError = false // Global error flag for checking input (parsing)
...
function addEntry() {
  ...
  let HTMLString = `
    ...
    <input id="${entryDropdown.value}-${entryNumber}-name" 
      type="text" placeholder="Name" />
    <label for="${entryDropdown.value}-${entryNumber}-calories">
      Entry ${entryNumber} Calories
    </label>
    <input id="${entryDropdown.value}-${entryNumber}-calories" 
